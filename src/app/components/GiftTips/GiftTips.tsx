...
export default function GiftTips() {
    ...
    const cards: { [key: string]: string } = {
        ...
        "Hobby Lobby": "https://www.hobbylobby.com/Gift-Cards/c/14?HLNextGenEcommIndex_prd%5Bconfigure%5D%5BhitsPerPage%5D=12&HLNextGenEcommIndex_prd%5Bconfigure%5D%5Bfacets%5D%5B0%5D=*&HLNextGenEcommIndex_prd%5Bconfigure%5D%5Bfilters%5D=categoryKeys%3A14&HLNextGenEcommIndex_prd%5Bconfigure%5D%5Bdistinct%5D=true&HLNextGenEcommIndex_prd%5Bconfigure%5D%5BfacetingAfterDistinct%5D=true&HLNextGenEcommIndex_prd%5Bconfigure%5D%5BclickAnalytics%5D=true",
    ...
    return (
        <div id="GIFT TIPS" className="flex flex-col items-center justify-center w-screen min-h-screen">
            ...
            <div className="p-3 max-w-xl text-xl">
                ...
                <br/>
                <p>If purchasing a giftcard, please use <i>nburnet1@duck.com</i> as the recipient email.</p>
            </div>
